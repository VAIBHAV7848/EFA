...
![EFA — the agent harness operating system](assets/hero.png)

[![Stars](https://img.shields.io/endpoint?url=https%3A%2F%2Fapi.efa.tools%2Fbadge%2Fstars&style=flat)](https://github.com/VAIBHAV7848/EFA/stargazers)
[![Forks](https://img.shields.io/endpoint?url=https%3A%2F%2Fapi.efa.tools%2Fbadge%2Fforks&style=flat)](https://github.com/VAIBHAV7848/EFA/network/members)
...
[![npm efa-agentshield](https://img.shields.io/npm/dw/efa-agentshield?label=efa-agentshield%20weekly%20downloads&logo=npm)](https://www.npmjs.com/package/efa-agentshield)
[![GitHub App Install](https://img.shields.io/endpoint?url=https%3A%2F%2Fapi.efa.tools%2Fbadge%2Finstalls&logo=github)](https://github.com/marketplace/efa-tools)
...
> [!WARNING]
> **Official sources only.** Install EFA only from verified channels: the GitHub repository [github.com/VAIBHAV7848/EFA](https://github.com/VAIBHAV7848/EFA), the npm packages [`efa-universal`](https://www.npmjs.com/package/efa-universal) and [`efa-agentshield`](https://www.npmjs.com/package/efa-agentshield), the [GitHub App](https://github.com/apps/efa-tools), the plugin slug `efa@efa`, and the project website [efa.tools](https://efa.tools). Third-party re-uploads and unofficial mirrors are not maintained or reviewed by the project and may contain malware.
...
EFA v2.0.0 adds the public Hermes operator story on top of that reusable layer: start with the [Hermes setup guide](docs/HERMES-SETUP.md), then review the [2.0.0 release notes](docs/releases/2.0.0/release-notes.md) and [cross-harness architecture](docs/architecture/cross-harness.md).
...
<td width="25%" align="center">
  <a href="https://efa.tools/pricing">
    <strong> EFA Pro</strong><br />
    <sub>Private repos · GitHub App · $19/seat/mo</sub>
  </a>
</td>
<td width="25%" align="center">
  <a href="https://github.com/sponsors/VAIBHAV7848">
    <strong> Sponsor</strong><br />
    <sub>Fund the OSS · From $5/mo</sub>
  </a>
</td>
<td width="25%" align="center">
  <a href="https://github.com/VAIBHAV7848/EFA/discussions">
...
<td width="25%" align="center">
  <a href="https://github.com/apps/efa-tools">
...
<sub>**OSS stays free.** This repo is MIT-licensed forever. EFA Pro is the hosted GitHub App for private repos. <a href="https://github.com/sponsors/VAIBHAV7848">Sponsors</a> and <a href="https://efa.tools/pricing">Pro subscribers</a> fund the work — that's why a single maintainer ships weekly across 7 harnesses.</sub>
...
<td align="center" width="220">
  <a href="https://www.greptile.com/go/efa">
    <img src="assets/images/sponsors/greptile.png" width="96" alt="Greptile logo" /><br />
    <strong>Greptile</strong>
  </a>
</td>
<td align="center" width="220">
  <a href="https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=EFA">
...
<sub><a href="https://github.com/sponsors/VAIBHAV7848"><strong>Become a Sponsor</strong></a> · <a href="SPONSORS.md">Sponsor Tiers</a> · <a href="SPONSORING.md">Sponsorship Program</a></sub>
...
<img src="./assets/images/shortform/00-header.png" width="420" alt="The Shorthand Guide to EFA" /><br />
<b>The Shorthand Guide</b>
</a>
<br /><sub>Setup, foundations, philosophy. <b>Read this first.</b> (<a href="https://x.com/VAIBHAV7848/status/2012378465664745795">thread</a>)</sub>
</td>
<td width="50%" align="center">
<a href="./the-longform-guide.md">
<img src="./assets/images/longform/01-header.png" width="420" alt="The Longform Guide to EFA" /><br />
<b>The Longform Guide</b>
</a>
<br /><sub>Token optimization, memory persistence, evals, parallelization. (<a href="https://x.com/VAIBHAV7848/status/2014040193557471352">thread</a>)</sub>
</td>
</tr>
</table>
...
<br /><sub>Attack vectors, sandboxing, sanitization, CVEs, AgentShield. (<a href="https://x.com/VAIBHAV7848/status/2033263813387223421">thread</a>)</sub>
</div>
...
Stable graduation of the 2.0 line: 261 skills, the control-pane substrate (session adapters + MCP inventory), the worktree-lifecycle service, the `orch-*` orchestrator family, and the launch of the [EFA Discord community](https://discord.gg/36yGMHGFbR). Full notes: [docs/releases/2.0.0/release-notes.md](docs/releases/2.0.0/release-notes.md).

### v2.0.0-rc.1 — Surface Refresh, Operator Workflows, and EFA 2.0 Alpha (Apr 2026)

- **Dashboard GUI** — New Tkinter-based desktop application (`efa_dashboard.py` or `npm run dashboard`) with dark/light theme toggle, font customization, and project logo in header and taskbar.
...
- **Operator and outbound workflow expansion** — `brand-voice`, `social-graph-ranker`, `connections-optimizer`, `customer-billing-ops`, `efa-tools-cost-audit`, `google-workspace-ops`, `project-flow-ops`, and `workspace-surface-audit` round out the operator lane.
- **Media and launch tooling** — `manim-video`, `remotion-video-creation`, and upgraded social publishing surfaces make technical explainers and launch content part of the same system.
- **Framework and product surface growth** — `nestjs-patterns`, richer Codex/OpenCode install surfaces, and expanded cross-harness packaging keep the repo usable beyond Claude Code alone.
- **Itô prediction-market skill pack** — `ito-market-intelligence`, `ito-basket-compare`, `ito-trade-planner`, `ito-data-atlas-agent`, `prediction-market-oracle-research`, and `prediction-market-risk-review` add public, non-advisory market/basket workflows while keeping live Itô API access gated and separate from EFA Tools billing.
...
- **EFA 2.0 alpha is in-tree** — the Rust control-plane prototype in `efa2/` now builds locally and exposes `dashboard`, `start`, `sessions`, `status`, `stop`, `resume`, and `daemon` commands. It is usable as an alpha, not yet a general release.
- **Operator status snapshots** — `efa status --markdown --write status.md` turns the local state store into a portable handoff covering readiness, active sessions, skill-run health, install health, pending governance events, and linked work items from Linear/GitHub/handoffs. Use `efa work-items upsert ...` for manual entries, `efa work-items sync-github --repo owner/repo` for PR/issue queue state, and `efa status --exit-code` to fail automation when readiness needs attention.
- **Ecosystem hardening** — AgentShield, EFA Tools cost controls, billing portal work, and website refreshes continue to ship around the core plugin instead of drifting into separate silos.
...
- **Harness-first release** — EFA is now explicitly framed as an agent harness performance system, not just a config pack.
...
- **Hook runtime controls** — `EFA_HOOK_PROFILE=minimal|standard|strict` and `EFA_DISABLED_HOOKS=...` for runtime gating without editing hook files.
...
- **GitHub Marketplace** — EFA Tools GitHub App live at [github.com/marketplace/efa-tools](https://github.com/marketplace/efa-tools) with free/pro/enterprise tiers
...
- **Fixed instinct import content loss** — `parse_instinct_file()` was silently dropping all content after frontmatter (Action, Evidence, Examples sections) during `/instinct-import`. ([#148](https://github.com/VAIBHAV7848/EFA/issues/148), [#161](https://github.com/VAIBHAV7848/EFA/pull/161))

### v1.4.0 — Multi-Language Rules, Installation Wizard & PM2 (Feb 2026)

- **Interactive installation wizard** — New `configure-efa` skill provides guided setup with merge/overwrite detection
...
See the full changelog in [Releases](https://github.com/VAIBHAV7848/EFA/releases).
...
- **Do not stack install methods.** The most common broken setup is: `/plugin install` first, then `install.sh --profile full` or `npx efa-install --profile full` afterward.

If you already layered multiple installs and things look duplicated, skip straight to [Reset / Uninstall EFA](#reset--uninstall-efa).

### Low-context / no-hooks path

If hooks feel too global or you only want EFA's rules, agents, commands, and core workflow skills, skip the plugin and use the minimal manual profile:
...
If you are not sure which EFA profile or component to install, ask the packaged advisor from any project:

```bash
npx efa consult "security reviews" --target claude
```
...
```bash
npx efa consult "mlops training model deployment" --target claude
npx efa install --profile minimal --target claude --with capability:machine-learning
```
...
EFA now has three public identifiers, and they are not interchangeable:

- GitHub source repo: `VAIBHAV7848/EFA`
- Claude marketplace/plugin identifier: `efa@efa`
- npm package: `efa-universal`

This is intentional. Anthropic marketplace/plugin installs are keyed by a canonical plugin identifier, so EFA uses `efa@efa` to keep tool names and slash-command namespaces short enough for strict Desktop/API validators. Older posts may still show the former long marketplace identifier; treat that as a legacy alias only. Separately, the npm package stayed on `efa-universal`, so npm installs and marketplace installs intentionally use different names.

### Step 2: Install Rules Only If You Need Them

> WARNING: **Important:** Claude Code plugins cannot distribute `rules` automatically.
>
> If you already installed EFA via `/plugin install`, **do not run `./install.sh --profile full`, `.\install.ps1 --profile full`, or `npx efa-install --profile full` afterward**. The plugin already loads EFA skills, commands, and hooks. Running the full installer after a plugin install copies those same surfaces into your user directories and can create duplicate skills plus duplicate runtime behavior.
>
> For plugin installs, manually copy only the `rules/` directories you want under `~/.claude/rules/efa/`. Start with `rules/common` plus one language or framework pack you actually use. Do not copy every rules directory unless you explicitly want all of that context in Claude.
>
> Use the full installer only when you are doing a fully manual EFA install instead of the plugin path.
>
> If your local Claude setup was wiped or reset, that does not mean you need to repurchase EFA. Start with `node scripts/efa.js list-installed`, then run `node scripts/efa.js doctor` and `node scripts/efa.js repair` before reinstalling anything. That usually restores EFA-managed files without rebuilding your setup. If the problem is account or marketplace access for EFA Tools, handle billing/account recovery separately.
...
# Plugin install path: copy only EFA rules into an EFA-owned namespace
mkdir -p ~/.claude/rules/efa
cp -R rules/common ~/.claude/rules/efa/
cp -R rules/typescript ~/.claude/rules/efa/

# Fully manual EFA install path (use this instead of /plugin install)
...
If EFA feels duplicated, intrusive, or broken, do not keep reinstalling it on top of itself.

- **Plugin path:** remove the plugin from Claude Code, then delete the specific rule folders you manually copied under `~/.claude/rules/efa/`.
...
EFA only removes files recorded in its install-state. It will not delete unrelated files it did not install.

If you stacked methods, clean up in this order:

1. Remove the Claude Code plugin install.
2. Run the EFA uninstall command from the repo root to remove install-state-managed files.
...
# Existing slash-style command names still work while EFA migrates off commands/.

# Plugin install uses the canonical namespaced form
/efa:plan "Add user authentication"
...
Launch the desktop dashboard to visually explore EFA components:

```bash
npm run dashboard
# or
python3 ./efa_dashboard.py
```
...
export EFA_HOOK_PROFILE=standard

# Comma-separated hook IDs to disable
export EFA_DISABLED_HOOKS="pre:bash:tmux-reminder,post:edit:typecheck"

# Cap SessionStart additional context (default: 8000 chars)
export EFA_SESSION_START_MAX_CHARS=4000

# Disable SessionStart additional context entirely for low-context/local-model setups
export EFA_SESSION_START_CONTEXT=off
...
export EFA_SESSION_RETENTION_DAYS=14

# Keep context/scope/loop warnings but suppress API-rate cost estimates
export EFA_CONTEXT_MONITOR_COST_WARNINGS=off
```

Windows PowerShell:

```powershell
[Environment]::SetEnvironmentVariable('EFA_CONTEXT_MONITOR_COST_WARNINGS', 'off', 'User')
[Environment]::SetEnvironmentVariable('EFA_SESSION_RETENTION_DAYS', '14', 'User')
```

### Agent data home (multi-harness isolation)

Memory persistence hooks (session summaries, learned skills, session aliases, metrics) store data under a single agent data root. By default that root is `~/.claude`. When you use EFA in both Claude Code and Cursor on the same machine, set a separate root for Cursor so the two environments do not overwrite each other's session files:

```bash
# Cursor-only boundary (Claude Code keeps the default ~/.claude)
export EFA_AGENT_DATA_HOME="$HOME/.cursor/efa"
```

Paths resolved under that root include:

- `$EFA_AGENT_DATA_HOME/session-data/` — session summaries
- `$EFA_AGENT_DATA_HOME/skills/learned/` — learned skills from evaluate-session
- `$EFA_AGENT_DATA_HOME/session-aliases.json` — session aliases
- `$EFA_AGENT_DATA_HOME/metrics/` — cost and activity metrics

See [VAIBHAV7848/EFA#2065](https://github.com/VAIBHAV7848/EFA/issues/2065).
...
|   |-- configure-efa/              # Interactive installation wizard (NEW)
...
|
|-- rules/            # Always-follow guidelines (copy to ~/.claude/rules/efa/)
...
|
|-- efa_dashboard.py  # Desktop GUI dashboard (Tkinter)
|
...
[Install EFA Tools GitHub App](https://github.com/apps/efa-tools) | [efa.tools](https://efa.tools)
...
npx efa-agentshield scan

# Auto-fix safe issues
npx efa-agentshield scan --fix

# Deep analysis with three Opus 4.6 agents
npx efa-agentshield scan --opus --stream

# Generate secure config from scratch
npx efa-agentshield init
```
...
Use `/security-scan` in Claude Code to run it, or add to CI with the [GitHub Action](https://github.com/VAIBHAV7848/agentshield).

[GitHub](https://github.com/VAIBHAV7848/agentshield) | [npm](https://www.npmjs.com/package/efa-agentshield)
...
**History:** This has caused repeated fix/revert cycles in this repo ([#29](https://github.com/VAIBHAV7848/EFA/issues/29), [#52](https://github.com/VAIBHAV7848/EFA/issues/52), [#103](https://github.com/VAIBHAV7848/EFA/issues/103)). The behavior changed between Claude Code versions, leading to confusion. We now have a regression test to prevent this from being reintroduced.
...
> mkdir -p ~/.claude/rules/efa
> cp -r rules/common ~/.claude/rules/efa/
> cp -r rules/typescript ~/.claude/rules/efa/   # pick your stack
> cp -r rules/python ~/.claude/rules/efa/
> cp -r rules/golang ~/.claude/rules/efa/
> cp -r rules/php ~/.claude/rules/efa/
>
...
cp -r rules/golang ~/.claude/rules/efa/
cp -r rules/php ~/.claude/rules/efa/
cp -r rules/arkts ~/.claude/rules/efa/
...
# Do not nest manual installs under ~/.claude/skills/efa/.
...
Do not copy the raw repo `hooks/hooks.json` into `~/.claude/settings.json` or `~/.claude/hooks/hooks.json`. That file is plugin/repo-oriented and is meant to be installed through the EFA installer or loaded as a plugin, so raw copying is not a supported manual install path.
...
If you installed EFA via `/plugin install`, do not copy those hooks into `settings.json`. Claude Code v2.1+ already auto-loads plugin `hooks/hooks.json`, and duplicating them in `settings.json` causes duplicate execution and cross-platform hook conflicts.

Windows note: the Claude config directory is `%USERPROFILE%\\.claude`, not `~/claude`.

#### Configure MCPs

Claude plugin installs intentionally do not auto-enable EFA's bundled MCP server definitions. This avoids overlong plugin MCP tool names on strict third-party gateways while keeping manual MCP setup available.
...
EFA ships exactly one default connector (`chrome-devtools`); everything else is a skill wrapping a CLI/REST API or an opt-in catalog entry. The rule and the June 2026 audit that retired the previous six defaults live in [docs/MCP-CONNECTOR-POLICY.md](docs/MCP-CONNECTOR-POLICY.md).

If you already run your own copies of EFA-bundled MCPs, set:

```bash
export EFA_DISABLED_MCPS="chrome-devtools"
```

EFA-managed install and Codex sync flows will skip or remove those bundled servers instead of re-adding duplicates. `EFA_DISABLED_MCPS` is an EFA install/sync filter, not a live Claude Code toggle.
...
|--------------|-----------------|------------|
| Plan a new feature | `/efa:plan "Add auth"` | planner |
| Design system architecture | `/efa:plan` + architect agent | architect |
...
```
/efa:plan "Add user authentication with OAuth"
...
This is the most common issue. **Do NOT add a `"hooks"` field to `.claude-plugin/plugin.json`.** Claude Code v2.1+ automatically loads `hooks/hooks.json` from installed plugins. Explicitly declaring it causes duplicate detection errors. See [#29](https://github.com/VAIBHAV7848/EFA/issues/29), [#52](https://github.com/VAIBHAV7848/EFA/issues/52), [#103](https://github.com/VAIBHAV7848/EFA/issues/103).
</details>

<details>
<summary><b>Can I use EFA with Claude Code on a custom API endpoint or model gateway?</b></summary>

Yes. EFA does not hardcode Anthropic-hosted transport settings. It runs locally through Claude Code's normal CLI/plugin surface, so it works with:
...
If your gateway remaps model names, configure that in Claude Code rather than in EFA. EFA's hooks, skills, commands, and rules are model-provider agnostic once the `claude` CLI is already working.
...
Too many MCP servers eat your context. Each MCP tool description consumes tokens from your 200k window, potentially reducing it to ~70k. SessionStart context is capped at 8000 characters by default; lower it with `EFA_SESSION_START_MAX_CHARS=4000` or disable it with `EFA_SESSION_START_CONTEXT=off` for local-model or low-context setups.
...
Yes. EFA is cross-platform:
- **Cursor**: Pre-translated configs in `.cursor/`. See [Cursor IDE Support](#cursor-ide-support).
- **Gemini CLI**: Experimental project-local support via `.gemini/GEMINI.md` and shared installer plumbing.
- **OpenCode**: Full plugin support in `.opencode/`. See [OpenCode Support](#opencode-support).
- **Codex**: First-class support for both macOS app and CLI, with adapter drift guards and SessionStart fallback. See PR [#257](https://github.com/VAIBHAV7848/EFA/pull/257).
...
EFA provides Cursor IDE support with hooks, rules, agents, skills, commands, and MCP configs adapted for Cursor's project layout.
...
| Agents | 48 | `.cursor/agents/efa-*.md` when installed; prefixed to avoid collisions with user or marketplace agents |
...
EFA does not install root `AGENTS.md` into `.cursor/`. Cursor treats nested `AGENTS.md` files as directory context, so copying EFA's repo identity into a host project would pollute that project.

Cursor-native loading behavior can vary by Cursor build. EFA installs agents as `.cursor/agents/efa-*.md`; if your Cursor build does not expose project agents, those files still work as explicit reference definitions instead of hidden global prompt context.

### Memory and data isolation (Cursor + Claude Code)

EFA memory hooks reuse the same `scripts/hooks/*.js` as Claude Code. For Cursor, EFA tries to keep memory **out of `~/.claude` automatically**:

1. **Cursor `sessionStart` hook** (installed to `.cursor/hooks.json` on `--target cursor`) injects `EFA_AGENT_DATA_HOME` for the whole composer session.
2. **Hook runtime default** — when `CURSOR_VERSION` or `CURSOR_PROJECT_DIR` is present, hooks default to `~/.cursor/efa` if the env var is unset.
3. **Project config** — `.cursor/efa-agent-data.json` documents and overrides the path (`agentDataHome`).
4. **Always-on rule** — `.cursor/rules/efa-agent-data-home.mdc` reminds the agent where memory lives.
...
To **share** memory with Claude Code on purpose, set `EFA_AGENT_DATA_HOME=~/.claude` in the shell or in `.cursor/efa-agent-data.json`.

Continuous learning v2 instincts remain separate under `CLV2_HOMUNCULUS_DIR` (default `~/.local/share/efa-homunculus`).
...
EFA provides **first-class Codex support** for both the macOS app and CLI, with a reference configuration, Codex-specific AGENTS.md supplement, and shared skills.
...
# Automatic setup: sync EFA assets (AGENTS.md, skills, MCP servers) into ~/.codex
npm install && bash scripts/sync-efa-to-codex.sh
# or: pnpm install && bash scripts/sync-efa-to-codex.sh
# or: yarn install && bash scripts/sync-efa-to-codex.sh
# or: bun install && bash scripts/sync-efa-to-codex.sh

# Or manually: copy the reference config to your home directory
cp .codex/config.toml ~/.codex/config.toml
```

The sync script safely merges EFA MCP servers into your existing `~/.codex/config.toml` using an **add-only** strategy — it never removes or modifies your existing servers. Run with `--dry-run` to preview changes, or `--update-mcp` to force-refresh EFA servers to the latest recommended config.

For Context7, EFA uses the canonical Codex section name `[mcp_servers.context7]` while still launching the `@upstash/context7-mcp` package. If you already have a legacy `[mcp_servers.context7-mcp]` entry, `--update-mcp` migrates it to the canonical section name.
...
The repo also exposes a Codex repo-scoped marketplace (`.agents/plugins/marketplace.json`) whose entry points at the `plugins/efa/` plugin folder — Codex does not discover plugins whose local marketplace `source.path` is the repository root (`./`), so the entry must target a concrete plugin subdirectory:

```bash
codex plugin marketplace add VAIBHAV7848/EFA
codex plugin list
...
**Plugin mode is currently fragile on Codex.** Marketplace discovery and install work with this layout, but runtime skill loading from local/repo marketplaces is still unreliable upstream ([openai/codex#26037](https://github.com/openai/codex/issues/26037)): Codex copies only the plugin folder into its install cache, so plugins that reference shared repo content may not expose skills in a fresh session. If the cache health check reports missing manifest references, treat the plugin path as discovery-only and prefer the manual sync flow above (`scripts/sync-efa-to-codex.sh`), which is the supported Codex route. See [#2128](https://github.com/VAIBHAV7848/EFA/issues/2128) for the full investigation.
...
| everything-for-ai | Development conventions and patterns for the project |
...
Codex does **not yet provide Claude-style hook execution parity**. EFA enforcement there is instruction-based via `AGENTS.md`, optional `model_instructions_file` overrides, and sandbox/approval settings.
...
EFA ships three sample role configs:
...
EFA provides Zed project support through a conservative `.zed` adapter for project-local settings, flattened rules, agents, commands, and skills.
...
The adapter writes EFA-managed files under `.zed/` and keeps BYOK/OpenRouter credentials out of the repo. Configure Zed account or API keys through Zed's own settings UI or your local user settings.

---

## OpenCode Support

EFA provides **full OpenCode support** including plugins and hooks.
...
That npm plugin entry enables EFA's published OpenCode plugin module (hooks/events and plugin tools).
It does **not** automatically add EFA's full command/agent/instruction catalog to your project config.

For the full EFA OpenCode setup, either:
...
EFA provides **GitHub Copilot support** for VS Code via Copilot Chat's native instruction and prompt file system — no extra tooling required.
...
- **`.github/copilot-instructions.md`** — repository-level instructions, always injected into every Copilot Chat request. Contains EFA's core coding standards, security checklist, testing requirements, and git workflow.
- **`.github/prompts/*.prompt.md`** — reusable prompt files users invoke on demand. Each prompt walks Copilot through a specific EFA workflow such as planning, TDD, security review, build-fix, or refactor.
...
| EFA Feature | Copilot equivalent |
|-------------|-------------------|
...
GitHub Copilot does not have a hook system or a subagent API, so EFA's hook automations (auto-format, TypeScript check, session persistence, dev-server guard) and agent delegation are unavailable. The instruction and prompt layer still brings the full EFA coding philosophy — standards, security, TDD, and workflow — into every Copilot Chat session.

---

## Cross-Tool Feature Parity

EFA is the **first plugin to maximize every major AI coding tool**. Here's how each harness compares:
...
| `EFA_CONTEXT_MONITOR_COST_WARNINGS` | on | **off for subscription users** | Suppresses agent-facing API-rate estimate warnings while keeping context/scope/loop warnings |
...
If you use a Claude subscription and the context monitor's API-rate estimates are not useful, set `EFA_CONTEXT_MONITOR_COST_WARNINGS=off`. This only suppresses the agent-facing cost warnings; it does not disable context exhaustion, scope, or loop warnings.
...
- Use `EFA_DISABLED_MCPS` only to filter EFA-generated MCP configs during install/sync flows
...
EFA takes supply-chain and agent safety seriously.

- **Official sources only.** Install EFA only from the verified channels listed in the banner at the top of this README — the [GitHub repo](https://github.com/VAIBHAV7848/EFA), the `efa-universal` / `efa-agentshield` npm packages, the [GitHub App](https://github.com/apps/efa-tools), the plugin slug `efa@efa`, and [efa.tools](https://efa.tools). Third-party re-uploads and mirrors are unreviewed and may ship malware.
...
Featured sponsors are at the top of this README — full list and tiers in [SPONSORS.md](SPONSORS.md). [Become a sponsor](https://github.com/sponsors/VAIBHAV7848).

---

## Links

- **Shorthand Guide (Start Here):** [The Shorthand Guide to EFA](https://x.com/VAIBHAV7848/status/2012378465664745795)
- **Longform Guide (Advanced):** [The Longform Guide to EFA](https://x.com/VAIBHAV7848/status/2014040193557471352)
- **Security Guide:** [Security Guide](./the-security-guide.md) | [Thread](https://x.com/VAIBHAV7848/status/2033263813387223421)
- **Follow:** [@VAIBHAV7848](https://x.com/VAIBHAV7848)
