...
This file provides Gemini CLI with the baseline EFA workflow, review standards, and security checks for repositories that install the Gemini target.

## Overview

Everything For Ai (EFA) is a cross-harness coding system with 36 specialized agents, 142 skills, and 68 commands.
