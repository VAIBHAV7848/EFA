...
Common issues and solutions for Everything For Ai (EFA) plugin.
...
**Solutions:**
```bash
# First inspect what EFA still knows about this machine
efa list-installed
efa doctor
efa repair
...
# If the issue is marketplace/account access, use EFA Tools billing/account recovery separately; do not use reinstall as a proxy for account recovery
...
1. **Check GitHub Issues**: [github.com/VAIBHAV7848/EFA/issues](https://github.com/VAIBHAV7848/EFA/issues)
