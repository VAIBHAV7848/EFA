...
- rename the skill when EFA materially changes or expands the surface
- prefer EFA-native rules, skills, scripts, and MCPs over new default third-party dependencies
...
EFA ships skill subsets for other harnesses:
