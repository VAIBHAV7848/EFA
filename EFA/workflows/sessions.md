---
description: Manage Everything For Ai session history, aliases, and session metadata.
---

# Sessions Command

Manage Everything For Ai session history - list, load, alias, and edit sessions stored in `~/.claude/session-data/` with legacy reads from `~/.claude/sessions/`.
