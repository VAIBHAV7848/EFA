...
This directory contains EFA's Qwen CLI install template.
...
The managed install also writes `~/.qwen/efa-install-state.json` so future EFA updates and uninstalls can distinguish EFA-owned files from user-owned Qwen configuration.
