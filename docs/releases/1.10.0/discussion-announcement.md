...
EFA just crossed **140K stars**, and the public release surface had drifted too far from the actual repo.
...
EFA 2.0 is now **real as an alpha control-plane surface** in-tree under `efa2/`.
...
That does **not** mean the full EFA 2.0 roadmap is done.
...
- EFA 1.x is the battle-tested harness/workflow layer shipping broadly today
- EFA 2.0 is the alpha control-plane growing on top of it
