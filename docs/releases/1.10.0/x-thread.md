# X Thread Draft — EFA v1.10.0

EFA crossed 140K stars and the public surface had drifted too far from the actual repo.
...
EFA 2.0 is no longer just roadmap talk.

the `efa2/` control-plane alpha is in-tree, builds today, and already exposes:
