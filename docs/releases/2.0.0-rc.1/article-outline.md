# Article Outline - EFA v2.0.0-rc.1

## Working Title

Turning EFA Into a Cross-Harness Operating System
...
- chat, CLI, TUI, cron, and handoffs can sit above the reusable EFA layer
...
- Claude Code remains the core target, but EFA now treats Codex, OpenCode,
...
- AgentShield and EFA Tools work is mirrored into the roadmap so enterprise
