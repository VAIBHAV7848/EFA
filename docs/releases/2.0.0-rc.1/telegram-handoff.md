...
```text
Use the public EFA release pack in the repo:
...
1. Finalize one strong X thread for EFA v2.0.0-rc.1.
2. Finalize one strong LinkedIn post for EFA v2.0.0-rc.1.
3. Give me one 30-60 second Hermes x EFA video script and one 15-30 second variant.
