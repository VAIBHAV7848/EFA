...
This rc.1 note records a public teaser skill pack that connects EFA's skill
distribution loop with Itô prediction-market workflows while keeping the two
businesses separate.

EFA remains the open agent-harness substrate and EFA Tools remains the hosted
GitHub App / Pro surface. Itô remains a separate prediction-market basket
business. The link is distribution: EFA can ship reusable skills that make
...
1. EFA users discover useful public prediction-market skills.
...
5. Sanitized patterns can become new EFA skills.

This sends agent/tooling traffic toward Itô without making EFA Tools look like
