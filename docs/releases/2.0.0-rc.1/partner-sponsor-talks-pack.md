# EFA v2.0.0-rc.1 Partner, Sponsor, and Talks Pack
...
| Core revenue lanes | Sponsors, EFA Tools Pro, consulting, talks | Repeatable growth loop | Approval-gated outbound |
...
```text
EFA gives teams one reusable layer for skills, hooks, rules, MCP conventions,
...
```text
EFA 2.0 sponsor slot for cross-harness agent workflows
```
...
I am getting EFA v2.0.0-rc.1 ready for release review.
...
The sponsor fit is pretty direct: EFA reaches the exact builders who are
...
Repo: https://github.com/VAIBHAV7848/EFA
Sponsor: https://github.com/sponsors/VAIBHAV7848
Release notes: https://github.com/VAIBHAV7848/EFA/blob/main/docs/releases/2.0.0-rc.1/release-notes.md
...
```text
EFA 2.0 is getting close to rc.1.
...
```text
I am open to a small number of EFA 2.0 implementation sprints for teams that
are standardizing AI coding workflows.

The useful scope is usually:

1. audit the current harness setup;
2. turn repeated workflows into EFA skills, hooks, and rules;
...
```text
EFA started as an open-source workflow layer for Claude Code and is now moving
...
I can show how EFA uses reusable skills, hooks, MCP conventions, release gates,
...
```text
EFA v2.0.0-rc.1 preview pack is ready for final release review.

The main point: EFA 2.0 is a meta-harness for agentic work.
...
- "If your AI coding setup only works in one harness, it is not an operating
  system yet."
- "EFA 2.0 is the shared layer: skills, hooks, MCPs, release gates, and team
...
- The message claims native payments are ready before EFA Tools billing readback
  passes.
...
- Repo: <https://github.com/VAIBHAV7848/EFA>
- Release notes: <https://github.com/VAIBHAV7848/EFA/blob/main/docs/releases/2.0.0-rc.1/release-notes.md>
- Quickstart: <https://github.com/VAIBHAV7848/EFA/blob/main/docs/releases/2.0.0-rc.1/quickstart.md>
- Sponsor: <https://github.com/sponsors/VAIBHAV7848>
- Sponsor tiers: <https://github.com/VAIBHAV7848/EFA/blob/main/SPONSORS.md>
- Sponsoring guide: <https://github.com/VAIBHAV7848/EFA/blob/main/SPONSORING.md>
