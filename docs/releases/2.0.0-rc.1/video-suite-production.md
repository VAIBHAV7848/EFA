...
This is the production contract for the EFA 2.0 release video suite. It keeps
...
EFA 2.0 is the harness-native operator system for agentic work.
...
- reusable skills, rules, hooks, agents, MCP conventions, release gates, and
  operator workflows;
- `efa2/` as the alpha control-plane/TUI direction, not the whole product;
- AgentShield and supply-chain gates as the enterprise trust layer;
- OSS stays free, with GitHub Sponsors, EFA Tools Pro, and consulting as the
  funding surface.
...
```bash
EFA_VIDEO_SOURCE_ROOT=/path/to/efa_2_raws \
EFA_VIDEO_RELEASE_SUITE_ROOT=/path/to/efa_2_release_suite \
npm run release:video-suite -- --format json
```

`EFA_VIDEO_SOURCE_ROOT` should contain proof images and may contain an `_edited/`
subdirectory with edited source clips. `EFA_VIDEO_RELEASE_SUITE_ROOT` should
...
| `sf-thread-2-whatisecc.mp4` | What is EFA | category clarity and GitHub App explanation |
...
| --- | ---: | --- | --- |
| Primary launch video | 90-150s | 16:9 | `efa-2-primary-launch.mp4` |
| Install proof clip | 25-35s | 16:9 and 9:16 | `efa-2-install-proof-*` |
| What is EFA clip | 45-60s | 16:9 and 9:16 | `efa-2-what-is-efa-*` |
| Security proof clip | 45-60s | 16:9 and 9:16 | `efa-2-security-proof-*` |
| Money/proof clip | 30-45s | 16:9 and 9:16 | `efa-2-money-proof-*` |
| Coverage/social proof clip | 30-45s | 16:9 and 9:16 | `efa-2-social-proof-*` |
...
| --- | --- | ---: | ---: | --- |
| 01 | `sf-longform-full.mp4` | 161.12 | 177.68 | Cleaner opener: EFA as structured context with skills, commands, agents, hooks, and project setup. |
| 02 | `thread-2-ghapp-money.mp4` | 21.84 | 30.40 | Direct product thesis: agentic harness optimization. |
| 03 | `thread-2-ghapp-money.mp4` | 41.00 | 59.72 | Not another harness; EFA is the layer and tooling on top of harnesses. |
...
- `renders/efa-2-primary-launch-rough-v1.captions.srt`
...
| Output | Target |
| --- | --- |
| `efa-2-primary-launch.mp4` | 90-150s, 1920x1080, audio |
| `efa-2-primary-launch.captions.srt` | primary captions |
| `efa-2-install-proof-wide.mp4` | 25-35s, 1920x1080, audio |
| `efa-2-install-proof-vertical.mp4` | 25-35s, 1080x1920, audio |
| `efa-2-what-is-efa-wide.mp4` | 45-60s, 1920x1080, audio |
| `efa-2-what-is-efa-vertical.mp4` | 45-60s, 1080x1920, audio |
| `efa-2-security-proof-wide.mp4` | 45-60s, 1920x1080, audio |
| `efa-2-security-proof-vertical.mp4` | 45-60s, 1080x1920, audio |
| `efa-2-money-proof-wide.mp4` | 30-45s, 1920x1080, audio |
| `efa-2-money-proof-vertical.mp4` | 30-45s, 1080x1920, audio |
| `efa-2-social-proof-wide.mp4` | 30-45s, 1920x1080, audio |
| `efa-2-social-proof-vertical.mp4` | 30-45s, 1080x1920, audio |

## video-use compatible workflow

Use the same production shape as Video Use while keeping the EFA-specific media
stack intact:
...
| EFA Tools Pro | billing/product page only after live readback confirms claims |
| AgentShield | CLI output, policy category view, supply-chain gate |
| `efa2/` | alpha control-plane/TUI surface with alpha framing |
...
- first 10 seconds clearly say what EFA is;
