...
- **하네스 중심 릴리스** — EFA는 이제 단순 설정 모음이 아닌, 에이전트 하네스 성능 시스템으로 명시됩니다.
- **훅 안정성 개선** — SessionStart 루트 폴백, Stop 단계 세션 요약, 취약한 인라인 원라이너를 스크립트 기반 훅으로 교체.
- **훅 런타임 제어** — `EFA_HOOK_PROFILE=minimal|standard|strict`와 `EFA_DISABLED_HOOKS=...`로 훅 파일 수정 없이 런타임 제어.
...
- **GitHub 마켓플레이스** — [github.com/marketplace/efa-tools](https://github.com/marketplace/efa-tools)에서 무료/프로/엔터프라이즈 티어 제공
- **30명 이상의 커뮤니티 기여** — 6개 언어에 걸친 30명의 기여자
- **978개 내부 테스트** — 에이전트, 스킬, 커맨드, 훅, 룰 전반에 걸친 검증

전체 변경 내역은 [Releases](https://github.com/VAIBHAV7848/EFA/releases)에서 확인하세요.
...
[GitHub 앱 설치](https://github.com/apps/skill-creator) | [efa.tools](https://efa.tools)
...
Claude Code에서 `/security-scan`을 사용하거나, [GitHub Action](https://github.com/VAIBHAV7848/agentshield)으로 CI에 추가하세요.
...
> cp -r everything-for-ai/rules/typescript ~/.claude/rules/typescript   # 사용하는 스택 선택
>
...
|-------------|-------------|-----------------|
| 새 기능 계획하기 | `/efa:plan "인증 추가"` | planner |
| 시스템 아키텍처 설계 | `/efa:plan` + architect 에이전트 | architect |
...
[**스폰서 되기**](https://github.com/sponsors/VAIBHAV7848) | [스폰서 티어](../../SPONSORS.md) | [스폰서십 프로그램](../../SPONSORING.md)
...
- **요약 가이드 (여기서 시작):** [The Shorthand Guide to Everything For Ai](https://x.com/VAIBHAV7848/status/2012378465664745795)
- **상세 가이드 (고급):** [The Longform Guide to Everything For Ai](https://x.com/VAIBHAV7848/status/2014040193557471352)
- **팔로우:** [@VAIBHAV7848](https://x.com/VAIBHAV7848)
