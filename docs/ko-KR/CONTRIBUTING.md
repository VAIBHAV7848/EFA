...
1. 먼저 `skills/your-skill-name/` 아래에 일반적인 EFA 스킬로 추가합니다.
...
- **이슈:** [github.com/VAIBHAV7848/EFA/issues](https://github.com/VAIBHAV7848/EFA/issues)
