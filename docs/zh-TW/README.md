...
<img src="https://github.com/user-attachments/assets/1a471488-59cc-425b-8345-5245c7efbcef" alt="Everything For Ai 簡明指南" />
</a>
</td>
<td width="50%">
<a href="https://x.com/VAIBHAV7848/status/2014040193557471352">
<img src="https://github.com/user-attachments/assets/c9ca43bc-b149-427f-b551-af6840c368f0" alt="Everything For Ai 完整指南" />
</a>
</td>
</tr>
<tr>
...
# 複製規則（應用於所有專案）
cp -r everything-for-ai/rules/* ~/.claude/rules/
```
...
[安裝 GitHub App](https://github.com/apps/skill-creator) | [efa.tools](https://efa.tools)
...
# 複製規則
cp everything-for-ai/rules/*.md ~/.claude/rules/
...
如果您是透過 `/plugin install` 安裝 EFA，請不要再把這些鉤子複製到 `settings.json`。Claude Code v2.1+ 會自動載入外掛中的 `hooks/hooks.json`，重複註冊會導致重複執行以及 `${CLAUDE_PLUGIN_ROOT}` 無法解析。
...
- **簡明指南（從這裡開始）：** [Everything For Ai 簡明指南](https://x.com/VAIBHAV7848/status/2012378465664745795)
- **完整指南（進階）：** [Everything For Ai 完整指南](https://x.com/VAIBHAV7848/status/2014040193557471352)
- **追蹤：** [@VAIBHAV7848](https://x.com/VAIBHAV7848)
