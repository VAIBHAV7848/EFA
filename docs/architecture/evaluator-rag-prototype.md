...
EFA 2.0 needs a self-improving harness loop that can learn from real work
...
- EFA Tools: route evaluator findings into PR comments, check runs, and Linear
...
It models the rule VAIBHAV7848 set during the May 2026 cleanup: stale closure is
...
EFA Tools already flags missing RAG/evaluator evidence for retrieval,
...
Future EFA Tools work should consume these artifacts as fixture shape before it
...
work should consume these fixtures from EFA Tools before adding hosted
