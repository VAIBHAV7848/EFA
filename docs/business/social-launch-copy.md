...
EFA 2.0 is the harness-native operator system for agentic work: skills, hooks,
...
- Hermes import guidance for turning local operator workflows into public EFA skills

Start here: https://github.com/VAIBHAV7848/EFA
...
```text
EFA v2.0.0-rc.1 keeps the public surface honest:
- reusable EFA substrate in repo
...
In EFA we turned this into production checks via:
- /harness-audit
- /quality-gate
...
EFA v2.0.0-rc.1 pushes that further: reusable skills, thin harness adapters, and Hermes as the operator shell on top.
```
...
EFA 2.0 is the harness-native operator system for agentic work. The same reusable layer now reaches Claude Code, Codex, OpenCode, Cursor, Gemini, Zed, GitHub Copilot workflows, and terminal-only operator lanes.

This release-candidate surface includes:
- sanitized Hermes setup documentation
- release notes and launch collateral
- cross-harness architecture notes
- Hermes import guidance for turning local operator patterns into public EFA skills
