...
Si descubres una vulnerabilidad de seguridad en EFA, por favor repórtala de forma responsable.

**No abras un issue público de GitHub para vulnerabilidades de seguridad.**

En cambio, envía un correo a **<security@efa.tools>** con:
...
- El plugin de EFA y todos los scripts de este repositorio
- Scripts de hooks que se ejecutan en tu máquina
- Scripts del ciclo de vida de instalación/desinstalación/reparación
- Configuraciones de MCP incluidas con EFA
- El escáner de seguridad AgentShield ([github.com/VAIBHAV7848/agentshield](https://github.com/VAIBHAV7848/agentshield))
...
EFA se ejecuta dentro de Claude Code, que inyecta **recordatorios efímeros del lado del cliente** en la entrada del modelo en cada turno (recordatorios de TodoWrite, avisos de cambio de fecha, avisos de archivo modificado, etc.). Estos bloques:
...
- **AgentShield**: Analiza tu configuración de agentes en busca de vulnerabilidades — `npx efa-agentshield scan`
