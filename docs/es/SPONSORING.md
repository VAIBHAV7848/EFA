...
EFA se mantiene como un sistema de rendimiento del harness de agentes de código abierto para Claude Code, Cursor, OpenCode y Codex app/CLI.
...
| Growth Partner | $500/mes | Equipos adoptando activamente EFA | Beneficios de Pilot + sincronización mensual de office hours + orientación de integración de flujos de trabajo |
...
- Descargas de npm (`efa-universal`, `efa-agentshield`)
...
- GitHub Sponsors: [https://github.com/sponsors/VAIBHAV7848](https://github.com/sponsors/VAIBHAV7848)
- Sitio del proyecto: [https://efa.tools](https://efa.tools)
