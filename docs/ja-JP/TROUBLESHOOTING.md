...
Everything For Ai (EFA) プラグインの一般的な問題と解決策。
...
# 問題がMarketplace/アカウントアクセスの場合、EFA Toolsのbilling/アカウントリカバリーを別途使用
...
1. **GitHub Issuesを確認**: [github.com/VAIBHAV7848/EFA/issues](https://github.com/VAIBHAV7848/EFA/issues)
2. **デバッグログを有効化**:
   ```bash
   export CLAUDE_DEBUG=1
