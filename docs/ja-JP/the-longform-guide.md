# Everything For Ai 長文ガイド

![Header: The Longform Guide to Everything For Ai](./assets/images/longform/01-header.png)

---

> **前提条件**: このガイドは[Everything For Ai 簡潔ガイド](./the-shortform-guide.md)を基に構成されています。スキル、フック、サブエージェント、MCP、プラグインのセットアップがまだの場合は、先にそちらをお読みください。
...
簡潔ガイドと長文ガイドで取り上げたすべてのものはGitHubで利用可能です：`github.com/VAIBHAV7848/EFA`
...
*セッションストレージの例 -> <https://github.com/VAIBHAV7848/EFA/tree/main/examples/sessions>*
...
これらのフックを構築し、リポジトリの`github.com/VAIBHAV7848/EFA/tree/main/hooks/memory-persistence`に置いています。
...
この機能を実現する継続学習スキルを構築しました：`github.com/VAIBHAV7848/EFA/tree/main/skills/continuous-learning`
...
*両ガイドで取り上げたすべてのものはGitHubの[everything-for-ai](https://github.com/VAIBHAV7848/EFA)で利用可能です*
