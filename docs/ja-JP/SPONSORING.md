...
EFAはClaude Code、Cursor、OpenCode、Codex app/CLIにまたがるオープンソースのエージェントハーネスパフォーマンスシステムとして維持されています。
...
| グロースパートナー | $500/月 | EFAを積極的に導入するチーム | パイロット特典 + 月次オフィスアワー同期 + ワークフロー統合ガイダンス |
...
- npmダウンロード数（`efa-universal`、`efa-agentshield`）
...
- プロジェクトサイト: [https://efa.tools](https://efa.tools)
