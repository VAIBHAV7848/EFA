...
EFA, Claude Code, Cursor, OpenCode ve Codex app/CLI genelinde açık kaynaklı bir ajan performans sistemi olarak sürdürülmektedir.
...
| Growth Partner | $500/ay | EFA'yi aktif olarak benimseyen ekipler | Pilot avantajları + aylık ofis saatleri senkronizasyonu + iş akışı entegrasyon rehberliği |
...
- npm indirmeleri (`efa-universal`, `efa-agentshield`)
...
- Proje sitesi: [https://efa.tools](https://efa.tools)
