...
Bu projeye sponsor olan herkese teşekkürler! Desteğiniz EFA ekosisteminin büyümesini sağlıyor.

## Kurumsal Sponsorlar

*Burada yer almak için [Kurumsal sponsor](https://github.com/sponsors/VAIBHAV7848) olun*

## İşletme Sponsorları

*Burada yer almak için [İşletme sponsoru](https://github.com/sponsors/VAIBHAV7848) olun*

## Takım Sponsorları

*Burada yer almak için [Takım sponsoru](https://github.com/sponsors/VAIBHAV7848) olun*

## Bireysel Sponsorlar

*Burada listelenmek için [sponsor](https://github.com/sponsors/VAIBHAV7848) olun*
...
- `efa-universal` ve `efa-agentshield` için canlı npm kurulum/indirme metrikleri
...
[**Sponsor Olun →**](https://github.com/sponsors/VAIBHAV7848)
