...
Einheitliches Terminologie-Glossar für die deutsche (de-DE) Übersetzung von EFA.

Leitlinie: Etablierte englische Fachbegriffe und EFA-Oberflächennamen (`agents/`, `skills/`,
...
|---------|---------|-------|
| Agent | Agent | bleibt englisch — EFA-Oberfläche (`agents/`) |
| Skill | Skill | bleibt englisch — EFA-Oberfläche (`skills/`) |
| Hook | Hook | bleibt englisch — EFA-Oberfläche (`hooks/`) |
| Command | Command | bleibt englisch als EFA-Oberfläche (`commands/`); generisch sonst „Befehl“ |
| Rule | Rule | bleibt englisch als EFA-Oberfläche (`rules/`); generisch sonst „Regel“ |
| Harness | Harness | bleibt englisch — keine etablierte deutsche Entsprechung |
| Instinct | Instinct | bleibt englisch — EFA-Begriff aus Continuous Learning |
...
| Continuous Learning | Continuous Learning | EFA-Feature-Name bleibt englisch; beschreibend „kontinuierliches Lernen“ |
| Memory | Memory | als EFA-Konzept englisch; generisch „Speicher“ |
