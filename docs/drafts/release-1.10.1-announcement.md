# EFA 1.10.1 release announcement draft

EFA 1.10.1 is the follow-up stabilization release to 1.10.0.
...
- npm/package/release surfaces are aligned and `efa-universal@1.10.0` is live on npm
...
- Claude marketplace/plugin identifier: `everything-for-ai@everything-for-ai`
- npm package: `efa-universal`
- GitHub repo: `VAIBHAV7848/EFA`

Those are intentionally different surfaces. The plugin identifier follows Anthropic marketplace rules; the npm package remains `efa-universal`.
