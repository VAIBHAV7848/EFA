#!/usr/bin/env python3
"""
EFA Dashboard - Everything For Ai GUI
Cross-platform TkInter application for managing EFA components
"""
...
from scripts.lib.efa_dashboard_runtime import launch_terminal, maximize_window

logger = logging.getLogger(__name__)

# ============================================================================
# DATA LOADERS - Load EFA data from the project
# ============================================================================

def get_project_path() -> str:
    """Get the EFA project path - assumes this script is run from the project dir"""
...
class ECCDashboard(tk.Tk):
    """Main EFA Dashboard Application"""
    
    def __init__(self):
        super().__init__()
        
        self.project_path = get_project_path()
        self.title("EFA Dashboard - Everything For Ai")
        
        maximize_window(self)
        
        try:
            self.icon_image = tk.PhotoImage(file='assets/images/efa-logo.png')
    ...
    def create_widgets(self):
        ...
        try:
            self.logo_image = tk.PhotoImage(file='assets/images/efa-logo.png')
        ...
        self.title_label = ttk.Label(header_frame, text="EFA Dashboard", font=('Open Sans', 18, 'bold'))
...
Usage: This skill is automatically activated when working with related technologies."""
    ...
    def create_settings_tab(self):
        ...
        about_text = """EFA Dashboard v1.0.0
Everything For Ai GUI

A cross-platform desktop application for 
managing and exploring EFA components.

Version: 1.10.0
Project: github.com/VAIBHAV7848/EFA"""
