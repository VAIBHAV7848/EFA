...
>
> Use the EFA-owned namespace below for user-level Claude installs. Flat
> package-level destinations can collide with non-EFA rule packs and do not
> match the main README guidance.

```bash
# Create the EFA rule namespace once.
...
cp -r rules/angular ~/.claude/rules/efa/
cp -r rules/vue ~/.claude/rules/efa/
cp -r rules/nuxt ~/.claude/rules/efa/
cp -r rules/python ~/.claude/rules/efa/
cp -r rules/golang ~/.claude/rules/efa/
cp -r rules/web ~/.claude/rules/efa/
cp -r rules/swift ~/.claude/rules/efa/
cp -r rules/php ~/.claude/rules/efa/
cp -r rules/ruby ~/.claude/rules/efa/
