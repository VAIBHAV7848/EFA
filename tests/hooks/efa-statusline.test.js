/**
 * Tests for scripts/hooks/efa-statusline.js
 *
 * Run with: node tests/hooks/efa-statusline.test.js
 */
...
const { formatDuration, buildContextBar, readCurrentTask } = require('../../scripts/hooks/efa-statusline');
...
function makeTempConfig() {
  return fs.mkdtempSync(path.join(os.tmpdir(), 'efa-statusline-test-'));
}

function runTests() {
  console.log('\n=== Testing efa-statusline.js ===\n');
