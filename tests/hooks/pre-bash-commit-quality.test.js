...
function inTempRepo(fn) {
  ...
  try {
    ...
    spawnSync('git', ['config', 'user.name', 'EFA Test'], { cwd: repoDir, stdio: 'pipe', encoding: 'utf8' });
    spawnSync('git', ['config', 'user.email', 'efa@example.com'], { cwd: repoDir, stdio: 'pipe', encoding: 'utf8' });
