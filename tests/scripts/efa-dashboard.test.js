/**
 * Behavioral tests for efa_dashboard.py helper functions.
 */
...
const runtimeHelpersPath = path.join(repoRoot, 'scripts', 'lib', 'efa_dashboard_runtime.py');
...
spec = importlib.util.spec_from_file_location("efa_dashboard_runtime", r"""${runtimeHelpersPath}""")
...
spec.loader.exec_module(module)
try:
    module.launch_terminal('/definitely/not/a/real/efa/path')
