...
git clone https://github.com/yourusername/efa-kiro-public-repo.git
cd efa-kiro-public-repo
...
- **Migration Guide**: `docs/migration-from-efa.md` - For Claude Code users
