...
class SkillCreateOutput {
  ...
  header() {
    ...
    console.log(chalk.bold(chalk.magenta('║')) + chalk.bold('  EFA Skill Creator                                             ') + chalk.bold(chalk.magenta('║')));
...
`));
  ...
  footer() {
    ...
    console.log(chalk.dim(`  Powered by Everything For Ai • efa.tools`));
