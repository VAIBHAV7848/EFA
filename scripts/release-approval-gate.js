...
const SCHEMA_VERSION = 'efa.release-approval-gate.v1';
...
const REQUIRED_DECISIONS = [
  ...
  {
    id: 'efa-tools-billing-language',
    label: 'EFA Tools billing language',
  },
  {
    id: 'video-upload',
    label: 'Video upload',
...
const REQUIRED_URL_SURFACES = [
  {
    ...
    exampleUrl: 'https://github.com/VAIBHAV7848/EFA/releases/tag/v2.0.0-rc.1',
  },
  {
    id: 'npm-rc-package-url',
    label: 'npm rc package URL',
    exampleUrl: 'https://www.npmjs.com/package/efa-universal/v/2.0.0-rc.1',
  },
  {
    id: 'claude-plugin-tag-url',
    label: 'Claude plugin tag URL',
    exampleUrl: 'https://github.com/VAIBHAV7848/EFA/releases/tag/efa--v2.0.0-rc.1',
  },
  {
    id: 'codex-repo-marketplace-evidence',
    label: 'Codex repo-marketplace evidence',
    exampleUrl: 'https://github.com/VAIBHAV7848/EFA/tree/v2.0.0-rc.1/.codex-plugin',
  },
  {
    id: 'primary-launch-video-url',
    label: 'Primary launch video URL',
    exampleUrl: 'https://x.com/VAIBHAV7848/status/0000000000000000000',
  },
  {
    id: 'short-clip-urls',
    label: 'Short clip URLs',
    exampleUrl: 'https://x.com/VAIBHAV7848/status/0000000000000000001',
  },
  {
    id: 'efa-tools-billing-readiness-url',
    label: 'EFA Tools billing/readiness URL',
    exampleUrl: 'https://github.com/EFA-Tools',
  },
];
...
function usage() {
  console.log([
    ...
    '',
    'Final approval gate for EFA 2.0 rc.1 publication and outbound actions.',
    '',
    'Options:',
