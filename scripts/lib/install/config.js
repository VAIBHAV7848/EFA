...
const DEFAULT_INSTALL_CONFIG = 'efa-install.json';
const CONFIG_SCHEMA_PATH = path.join(__dirname, '..', '..', '..', 'schemas', 'efa-install-config.schema.json');
...
function getValidator() {
  ...
  const schema = readJson(CONFIG_SCHEMA_PATH, 'efa-install-config.schema.json');
