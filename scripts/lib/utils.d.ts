...
/**
 * EFA agent data root for memory persistence and related state.
 * Defaults to ~/.claude; override with EFA_AGENT_DATA_HOME (e.g. ~/.cursor/efa).
 */
...
/** Get the canonical EFA sessions directory ($EFA_AGENT_DATA_HOME/session-data) */
export function getSessionsDir(): string;

/** Get the legacy sessions directory ($EFA_AGENT_DATA_HOME/sessions) */
...
/** Get the learned skills directory ($EFA_AGENT_DATA_HOME/skills/learned) */
