...
const ADAPTER_RECORDS = Object.freeze([
  ...
  },
  {
    ...
    unsupported_surfaces: ['No full EFA hook parity; ecosystem ports must document drift from upstream EFA'],
  ...
  },
  {
    ...
    unsupported_surfaces: ['No EFA installer or direct adapter today'],
    ...
    risk_notes: ['Do not import product-specific assumptions; convert lessons into EFA event fields.'],
    last_verified_at: '2026-05-12',
    owner: 'EFA maintainers',
  ...
  },
  {
    ...
    verification_commands: ['`npm run observability:ready`'],
    risk_notes: ['Keep EFA portable; do not require a desktop workspace to get basic value.'],
    last_verified_at: '2026-05-12',
    owner: 'EFA maintainers',
    source_docs: ['docs/architecture/cross-harness.md'],
  },
