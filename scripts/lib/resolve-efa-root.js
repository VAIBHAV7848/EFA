...
/**
 * Resolve the EFA source root directory.
 *
 * Tries, in order:
 ...
 *   4. Plugin cache auto-detection — scans ~/.claude/plugins/cache/{efa,everything-for-ai}/
 ...
 *                                    contains EFA scripts. Default: 'scripts/lib/utils.js'
 * @returns {string} Resolved EFA root path
 */
