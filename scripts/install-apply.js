#!/usr/bin/env node
/**
 * Refactored EFA installer runtime.
 *
...
Targets:
  claude       (default) - Install EFA into ~/.claude/ with managed rules/skills under rules/efa and skills/efa
  claude-project - Install EFA into ./.claude/ (per-project) with managed rules/skills under rules/efa and skills/efa
...
Options:
  ...
  --config <path>     Load install intent from efa-install.json
