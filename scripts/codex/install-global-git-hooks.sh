...
# Install EFA git safety hooks globally via core.hooksPath.
# Usage:
...
DEST_DIR="${EFA_GLOBAL_HOOKS_DIR:-$HOME/.codex/git-hooks}"
...
log "Installed EFA global git hooks."
log "Disable per repo by creating .efa-hooks-disable in project root."
log "Temporary bypass: EFA_SKIP_PRECOMMIT=1 or EFA_SKIP_PREPUSH=1"
