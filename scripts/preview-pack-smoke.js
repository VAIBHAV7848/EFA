...
const SCHEMA_VERSION = 'efa.preview-pack-smoke.v1';
...
const HERMES_BOUNDARY_MARKERS = [
  ...
  'EFA v2.0.0-rc.1 documents the Hermes surface',
...
function usage() {
  console.log([
    ...
    '',
    'Deterministic smoke gate for the EFA 2.0 rc.1 preview pack.',
    '',
    'Options:',
