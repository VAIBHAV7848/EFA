...
## The Pipeline — mixing the EFA video skills

This skill is the conductor. Each EFA skill is an instrument. Do not skip layers.
...
| Step | EFA skill to load | What it does here |
|------|-------------------|-------------------|
