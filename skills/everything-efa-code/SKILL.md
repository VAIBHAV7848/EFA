...
description: Development conventions and patterns for everything-for-ai. JavaScript project with conventional commits.
---

# Everything For Ai Conventions

> Generated from [affaan-m/everything-for-ai](https://github.com/affaan-m/everything-for-ai) on 2026-03-20

## Overview

This skill teaches Claude the development patterns and conventions used in everything-for-ai.
...
```text
fix: auto-detect EFA root from plugin cache when CLAUDE_PLUGIN_ROOT is unset (#547) (#691)
```
...
```text
feat: add block-no-verify hook for Everything For Ai and Cursor (#649)
```
...
*This skill was auto-generated by [EFA Tools](https://efa.tools). Review and customize as needed for your team.*
