...
If the repo has EFA2 state enabled, prefer adding or reading checkpoints through the EFA control pane or state-store-backed scripts instead of scattering untracked notes.
