...
description: >-
  Analyze raw prompts, identify intent and gaps, match EFA components
...
Analyze a draft prompt, critique it, match it to EFA ecosystem components,
...
- User says "how should I use EFA for..."
...
- User is asking about EFA configuration (use `configure-efa` instead)
...
### Phase 3: EFA Component Matching

Map intent + scope + tech stack (from Phase 0) to specific EFA components.
...
### Section 2: Recommended EFA Components
...
A compact version for experienced EFA users. Vary by intent type:
...
|-----------|------------------|
| `configure-efa` | User hasn't set up EFA yet |
