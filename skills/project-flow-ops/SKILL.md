...
| Port/Rebuild | useful idea, but should be manually re-landed inside EFA |
...
- External-source features should be rebuilt inside EFA when they are valuable but not self-contained
...
- "Map GitHub issues into our EFA 1.x and EFA 2.0 program lanes"
