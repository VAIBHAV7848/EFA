# plugins/efa — Codex Repo-Marketplace Plugin Target
...
With this layout, `codex plugin marketplace add VAIBHAV7848/EFA` discovers and
installs `efa@efa`. Runtime skill loading from repo marketplaces is still
...
and [VAIBHAV7848/EFA#2128](https://github.com/VAIBHAV7848/EFA/issues/2128)).

After install, `codex plugin list` is not enough to prove the runtime can load
the referenced skills and assets. From an EFA checkout, run:
