---
description: Navigate EFA's current agents, skills, commands, hooks, install profiles, and docs from the live repository surface.
---

# /efa-guide

Use this command as a conversational map of Everything For Ai. It should help the user discover the right EFA surface for their task without dumping the entire README or stale catalog counts.
...
/efa-guide hooks
/efa-guide install
/efa-guide find: <query>
/efa-guide <feature-or-file-name>
```
...
- `scripts/ci/catalog.js --json` for live catalog counts when running inside EFA
...
- `/project-init` for stack-aware EFA onboarding of a target project
