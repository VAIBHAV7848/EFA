---
description: Generate a local Everything For Ai cost report from a cost-tracker SQLite database.
argument-hint: [csv]
---
...
trusted Everything For Ai cost-tracking hook/plugin first.
