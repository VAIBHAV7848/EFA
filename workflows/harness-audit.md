...
The script audits the current working directory by default and auto-detects whether the target is the EFA repo itself or a consumer project using EFA.
...
6. Suggested EFA skills to apply next.
