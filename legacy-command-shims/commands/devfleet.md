---
description: Legacy slash-entry shim for the efa-devfleet skill. Prefer the skill directly.
---

# DevFleet (Legacy Shim)

Use this only if you still call `/devfleet`. The maintained workflow lives in `skills/efa-devfleet/SKILL.md`.

## Canonical Surface

- Prefer the `efa-devfleet` skill directly.
