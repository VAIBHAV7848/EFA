...
Use this playbook when release copy or roadmap text mentions EFA Tools
...
2. Check the current repo and public listing surfaces:
   - `gh api repos/EFA-Tools/EFA-Tools`
   - `https://github.com/marketplace/efa-tools`
...
- `rg -n "billing|Billing|Marketplace|marketplace|subscription|seat|entitlement|plan" README.md docs/releases/2.0.0-rc.1 docs/EFA-2.0-GA-ROADMAP.md`
- `gh api repos/EFA-Tools/EFA-Tools`
- Manual live check of `https://github.com/marketplace/efa-tools`
- `npx --yes markdownlint-cli docs/releases/2.0.0-rc.1/*.md docs/EFA-2.0-GA-ROADMAP.md`
- `git diff --check`
