#!/usr/bin/env node
/**
 * EFA CodeBuddy Installer (Cross-platform Node.js version)
...
function doInstall() {
  ...
  console.log('EFA CodeBuddy Installer');
  console.log('=======================');
  console.log('');
  ...
  // Add manifest itself
  ensureManifestEntry(manifest, '.efa-manifest');
  ...
  console.log('  3. Enjoy the EFA workflows!');
  console.log('');
